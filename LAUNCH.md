...
- [ ] ⚠️ **НОВЫЙ ФАЙЛ с 08-06: `extension/icon.js`** — обязателен в архиве (иконка-таймер).
      `importScripts` обёрнут в try, так что забытый файл расширение не убьёт, но иконка молча пропадёт.
