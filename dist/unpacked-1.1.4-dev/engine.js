...
(function () {
  ...
  class AudioEngine {
    ...
    _apply() {
      ...
      const cutoff = (430 + arousal * 470) * (1 - depth * 0.30) * (0.92 + tod * 0.12) * (1 - 0.5 * land);
      this.brownLP.frequency.setTargetAtTime(clamp(cutoff, 150, 1000), t, 2.0);
      ...
      this.brownGain.gain.setTargetAtTime((0.5 + masking * 0.5 * thin) * trim * (1 - land * 0.94), t, 2.0);
      ...
      this.pinkGain.gain.setTargetAtTime((0.02 + arousal * 0.03) * (1 - masking * 0.6) * trim * (1 - land * 0.7), t, 2.5);
